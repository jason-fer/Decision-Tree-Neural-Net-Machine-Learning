...
class Debug {
  ...
  /**
   * Backtrace can't be done when calling through the pwp() function in the
   * index file. The reason is, if you backtrace here, it will always just
   * give you the location of pwp() which is wrong! So, this just returns
   * a debug result for pwp() to display (from the index file where the 
   * function resides)
   * 
   * @return string formatted output
   */
  public static function e_pwp()
  {
    if (func_num_args() === 0)
      return;
